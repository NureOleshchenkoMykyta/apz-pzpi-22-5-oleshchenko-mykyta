...
public final class ResultItemBinding implements ViewBinding {
  ...
  private ResultItemBinding(@NonNull LinearLayout rootView, @NonNull TextView resultTextView) {
  ...
  public static ResultItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ResultItemBinding((LinearLayout) rootView, resultTextView);
    }
